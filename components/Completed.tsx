...
const data = [
    { id: 1, task: "Completed Task" },
    { id: 2, task: "Completed Task" },
    { id: 3, task: "Completed Task" },
    { id: 4, task: "Completed Task" },
    { id: 5, task: "Completed Task" },
    { id: 6, task: "Completed Task" },
    { id: 7, task: "Completed Task" },
    { id: 8, task: "Completed Task" }
]



const Completed = () => {
    const [completedTask, setCompletedTask] = useState(data)
    const handleDelete = (id: number) => {
        const updatedTask = completedTask.filter(task => task.id !== id)
